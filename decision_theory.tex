...
Uncertainty sampling: Ask user to label the example that we are most uncertain about: $i_t \in \argmin_i | 0.5 - \hat{P} (Y_i|x_i)|$. Active learning \red{violates i.i.d. assumption}.
